// need to modify the original program from the book using pointers
// The task is to move all external variables into main and modify functions
// in a way that they still get everything
// analyze hand needs to change variables, so you need to pass em to it.
