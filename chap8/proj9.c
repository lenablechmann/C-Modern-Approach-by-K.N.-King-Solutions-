...
int main(void)
{
    ...
    ground[row][column - 1] == '.')
    {
        ...
        {
        case 0: // down
        if (ground[row + 1][column] == '.' && row < 9){ //down
           row = row + 1;
           column = column;
           break;
        }
        if (ground[row - 1][column] == '.' && row > 0){ // goes up.
           row = row - 1;
           column = column;
           break;
        }
        if (ground[row][column + 1] == '.' && column < 9){ // goes right.
           row = row;
           column = column + 1;
           break;
        }
        if (ground[row][column - 1] == '.' && column > 0){ // goes left.
           row = row;
           column = column - 1;
           break;
        }
        ...
        case 2: // left
        if (ground[row][column - 1] == '.' && column > 0){ //left
           row = row;
           column = column - 1;
           break;
        }
        ...
        if (ground[row - 1][column] == '.' && row > 0){ // up
           row = row - 1;
           column = column;
           break;
        }
        if (ground[row][column + 1] == '.' && column < 9){ // right
           row = row;
           column = column + 1;
           break;
        }
