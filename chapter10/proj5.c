...
bool royal_flush, straight, flush, four, three, ace_low;
...
void analyze_hand(void)
{
  ...
  /* check for straight, and royal flush and ace low */
  for (rank = 0; rank < 13; rank++) 
  {
    ...
    if (rank_repeat[0] == 1 && rank_repeat[1] == 1 &&
    rank_repeat[2] == 1 && rank_repeat[3] == 1 && rank_repeat[12] == 1)
    ace_low = true;
